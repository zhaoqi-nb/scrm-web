...
class Index extends Component {
  ...
  render() {
    ...
    return <>
      <Table onChange={this.handleChangeTable} loading={loading} scroll={{ x: 'max-content', y: 300 }} columns={tableType == 1 ? groupLeaderColumns : groupColumns} pagination={pagination} dataSource={dataSource} />
