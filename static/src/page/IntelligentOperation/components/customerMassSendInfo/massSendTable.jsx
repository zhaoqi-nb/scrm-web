...
import { Table, Space, Button, Radio, Tooltip, Avatar } from 'antd'
...
class Index extends Component {
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
          <Radio.Group
            ...
            defaultValue=""
            optionType="button"
            options={radioTypeOptions[tableType]}
            style={{ margin: '16px 0' }}
          />
  ...
  render() {
    const { dataSource, loading, memberColumns, pagination, customerColumns, visible, modalType } = this.state
    const { tableType } = this.props // 1 成员详情 2 客户详情
    return (
      <>
        {this.renderFiler()}
        <Table
          ...
          columns={tableType == 1 ? memberColumns : customerColumns}
