...
export default function ClientAttribute({ data, onPress }) {
    ...
    const onFinish = (data) => {
        ...
        onPress({ index: 1, ...result, attributeLists: [result?.screens], attributeType: 1 })
    }
    return (
        <div className="ClientAttribute">
            ...
            >
                ...
                <Form.Item ><SelectCustom formRef={ref} /></Form.Item>
                {
