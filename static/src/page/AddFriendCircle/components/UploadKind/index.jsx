...
import { UploadAll, MaterialModal } from '../index'
import { UploadOutlined, LoadingOutlined, DeleteOutlined } from '@ant-design/icons'


export default function UploadKind({ onChange }) {
    ...
    const bottomRender = () => {
        if (checkKey === 1) {
            return <UploadAll checkKey={checkKey} handelChange={handelChange} />
        } else if (checkKey === 2) {
            return <UploadAll type="video" checkKey={checkKey} handelChange={handelChange} />
        } else {
